...
local LOADER_URL = "https://raw.githubusercontent.com/xekarthan2527-boop/XEK/refs/heads/main/UI-ScriptRoblox99" -- ลิงค์ไฟล์นี้แหละ เอาไว้รีโหลดตอนวาปแมพ
...
local function loadGame(key)
    ...
    local url = GETSCRIPT_BASE.."?key="..key.."&placeId="..game.PlaceId.."&hwid="..hwid
